...
Please download and unzip the [Dlib face landmarks dat file](http://dlib.net/files/shape_predictor_68_face_landmarks.dat.bz2) into the 'res' folder.
...
If org registration fails, please check the number of registered devices in DeepAffex™ dashboard and ensure that you have not reached the registered devices limit.
